    ...
    <div class="roww">
      ...
      <div class="buy">
        ...
        <div class="button my-3">
          <button class="py-2 w-25 ms-4"><a href="<?= base_url('Schedule/index/') . $filmId['id_film'] . '/' . $filmId['judul']; ?>" class="nav-link">Buy Ticket</a></button>
          <button class="py-2 w-25"><a href="<?= base_url('home/trailler/') . $filmId['id_film']; ?>" class="nav-link">Trailler</a></button>
        </div>
        <h5>Released date</h5>
